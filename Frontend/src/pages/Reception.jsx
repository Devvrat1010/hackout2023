      ...
      <div className="flex gap-x-10 justify-between p-10">
        <div className="-mt-12"> 
          ...
          <div className="mt-5 ml-64">
            <button className="bg-blue-800 text-white px-6 py-4 rounded-sm transition duration-300 ease-in-out transform hover:translate-y-1 hover:bg-blue-600 hover:text-black font-semibold">About Us</button>
